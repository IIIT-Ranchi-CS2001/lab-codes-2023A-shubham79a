...
# key=0 sort accordingly to customer naming
# key=1 sort accordingly to customer id
# key=2 sort accordingly to customer shopping points


# we will be using bubble sort for sorting
